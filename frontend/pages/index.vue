<template>
    <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <form @submit.prevent="uploadFile" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-sm">
        <div class="mb-4">
    ...
    setup() {
      ...
      const viewStatus = async () => {
        try {
          ...
          alertMessage.value = "Error fetching status information. Please try again.";
          setTimeout(() => {
            alertMessage.value = null;
          }, 3000);
        }
